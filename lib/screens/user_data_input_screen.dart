...
class _UserInputScreenState extends State<UserInputScreen> {
  ...
  final TextEditingController _apHiCVDController =
      TextEditingController(); // controller for ap hi field
  final TextEditingController _apLoCVDController =
      TextEditingController(); // controller for ap lo field
  final TextEditingController _glucoseCVDController =
  ...
  final TextEditingController _alcoholCVDController =
      TextEditingController(); // controller for alcohol intake text field
  final TextEditingController _physicalCVDController =
      TextEditingController(); // controller for physical activity text field
          ...
          children: [
            Center(
              child: Image.asset(
                ...
                width: iconSize *
                    10.8, // adjust width of image using current screen width
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    buildRiskInputField(
                        ...
                        TextInputType.number,
                        _apHiCVDController), // create input field
                    ...
                    buildRiskInputField(
                        ...
                        "Enter valid pressure",
                        TextInputType.number,
                        _apLoCVDController), // create input field

                    buildRiskInputField(
                        "Cholesterol level :",
                        "insert cholesterol level",
                        _isValidHeight,
                    ...
                    buildRiskInputField(
                        "Glucose level :",
                        "insert glucose level",
                        _isValidHeight,
                        "Enter valid glucose level",
                        TextInputType.number,
                        _glucoseCVDController), // create input field
                    ...
                    buildRiskInputField(
                        ...
                        "Enter yes or only",
                        TextInputType.text,
                        _alcoholCVDController), // create input field
                    ...
                    buildRiskInputField(
                        ...
                        "Enter yes or only",
                        TextInputType.text,
                        _physicalCVDController), // create input field
  ...
  void _predictCVDLevel(double iconSize) async {
    if (_formKey.currentState!.validate()) {
      ...
      final response = await http.post(
        Uri.parse(
            'https://api-oka6pmsbjq-ue.a.run.app/cvd_api_endpoint'), // API endpoint
      ...
      if (response.statusCode == 200) {
        int predictVal =
            json.decode(response.body); // get response from the API
        String cvdLevel = "";
        if (predictVal == 0) {
          cvdLevel = "Low Risk";
        ...
        if (cvdLevel == "Low Risk") {
          ...
          showCVDRiskLevel(
              context,
              cvdLevel,
              'You are at a Risk for developing a cardiovascualr disease!',
